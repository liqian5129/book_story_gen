    ...
    >
      ...
      <Img
        ...
        style={{
          ...
          opacity: 0.65,
          transform: `scale(1.12) translateX(${interpolate(frame, [0, FILM_DURATION], [-2, 2], { extrapolateLeft: "clamp", extrapolateRight: "clamp" })}%) translateY(${interpolate(frame, [0, FILM_DURATION], [1, -1], { extrapolateLeft: "clamp", extrapolateRight: "clamp" })}%)`,
        }}
      />
